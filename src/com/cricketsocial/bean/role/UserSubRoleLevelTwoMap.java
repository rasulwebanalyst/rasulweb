...
public class UserSubRoleLevelTwoMap {

/*	CREATE TABLE cricketsocial.user_sub_role_level_two_map (
			user_id text,
			role_id text,
			...
			PRIMARY KEY (user_id,role_id,sub_role_level_one_id,sub_role_level_two_id)
		);*/
