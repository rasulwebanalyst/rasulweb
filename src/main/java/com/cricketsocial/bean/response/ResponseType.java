<<<<<<< HEAD:src/main/java/com/cricketsocial/bean/response/ResponseType.java
...
public class ResponseType {
	...
	private List<Roster> rosterDetails;
	 ...
	 private Roaster rosterPrintDetails;
	...
	public void setTeamContactDetailList(List<BoardProfile> teamContactDetailList) {
		this.teamContactDetailList = teamContactDetailList;
	}

	public Roaster getRosterPrintDetails() {
		return rosterPrintDetails;
	}

	public void setRosterPrintDetails(Roaster rosterPrintDetails) {
		this.rosterPrintDetails = rosterPrintDetails;
	}
...
>>>>>>> 54bab19c58bde60aeb971a37e418c05bb2f4f3de:src/com/cricketsocial/bean/response/ResponseType.java
