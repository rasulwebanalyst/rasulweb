...
public class BoardUmpire {
   ...
   private String tournamentSelectOption;
...
public String getTournamentSelectOption() {
	return tournamentSelectOption;
}
public void setTournamentSelectOption(String tournamentSelectOption) {
