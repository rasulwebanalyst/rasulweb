...
function eventfun(){
	...
	htm +='<p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Reject" disabled="disabled"><br>';
	...
	htm +='<p> <input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Accept" disabled="disabled"><br>';
...
function getDateInObjectFormate_withTimeStampInput(timestamp)
{
		...
		//var date = new Date(datestr2.toUTCString()) ;
		//var date = new Date(datestr2.getFullYear(),datestr2.getMonth(),datestr2.getDay(),datestr2.getHours(), datestr2.getMinutes()) ;
			...
			if(res!=null)
				{
						...
						if(nextindicate<=0){
							  // htm2 ='<a class="btn btn-default dBtn pull-right lodbtn" href="javascript:getallFanlistPagination('+category2+','+page+','+display2+','+pageCall2+')">Load more</a>';
							  htm2 +='';
							   displaynotification('No more events',2000);
						}else{
		                ...
		                //    var tournamentSchedulerId="'"+event.tournamentSchedulerId+"'";	                		
		                   ...
		                   if(event.player_role == 'Captian'){
			            	  htm+='<button type="submit" class="btn dBtn pull-right btnalian" onclick="showRateUmpireForm('+tournamentName+','+tournamentSchedulerId+','+homeboardId+','+tournamentId+','+date+')" >Rate Umpire</button>';
			            	   ...
			            	   if(res.buddyMatchInvitationList[i].statusId==30){
				            	   htm+='<div class="col-md-6 threebtn">';	   
				            	   htm+=' <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Reject"  onclick="schedualStatus(198,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteReject'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',201)" id="invitationacceptcountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">Rejected :'+res.buddyMatchInvitationList[i].rejectedCount+'</a></p>';
				            	   htm+=' <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="May Be"  onclick="schedualStatus(197,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteMaybe'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',202)" id="invitationmaybecountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">May Be : '+res.buddyMatchInvitationList[i].maybeCount+'</a></p>';
				            	   htm+='<p> <input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Accept" disabled="disabled" onclick="schedualStatus(196,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteAccept'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',200)" id="invitationrejectcountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">Accepted : '+res.buddyMatchInvitationList[i].acceptedCount+'</a></p>';
				            	   htm+='</div>';
			            	   }else if(res.buddyMatchInvitationList[i].statusId==31){
			            		   htm+='<div class="col-md-6 threebtn">';	   
				            	   htm+=' <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Reject"  onclick="schedualStatus(198,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteReject'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',201)" id="invitationacceptcountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">Rejected :'+res.buddyMatchInvitationList[i].rejectedCount+'</a></p>';
				            	   htm+=' <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="May Be" disabled="disabled" onclick="schedualStatus(197,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteMaybe'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',202)" id="invitationmaybecountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">May Be : '+res.buddyMatchInvitationList[i].maybeCount+'</a></p>';
				            	   ...
				            	   htm+='</div>';
			            	   }else if(res.buddyMatchInvitationList[i].statusId==35){
			            		   htm+='<div class="col-md-6 threebtn">';	   
				            	   htm+=' <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Reject" disabled="disabled" onclick="schedualStatus(198,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteReject'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',201)" id="invitationacceptcountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">Rejected :'+res.buddyMatchInvitationList[i].rejectedCount+'</a></p>';
				            	   htm+=' <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="May Be"  onclick="schedualStatus(197,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteMaybe'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',202)" id="invitationmaybecountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">May Be : '+res.buddyMatchInvitationList[i].maybeCount+'</a></p>';
				            	   htm+='<p> <input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Accept"  onclick="schedualStatus(196,'+eventMatchMapId+','+rosterId+','+playerId+','+tournamentSchedulerId+','+invitationacceptcountdisp+','+invitationmaybecountdisp+','+invitationrejectcountdisp+')" id="inviteAccept'+res.buddyMatchInvitationList[i].eventMatchMapId+'"><br><a href="javascript:gettingmatchAcceptedPeopleList('+eventMatchMapId+','+tournamentSchedulerId+','+rosterId+','+accept+',200)" id="invitationrejectcountdisp'+res.buddyMatchInvitationList[i].eventMatchMapId+'">Accepted : '+res.buddyMatchInvitationList[i].acceptedCount+'</a></p>';
				            	   htm+='</div>';
			            	   }else{
						...
						if(event!=null){
			               ...
			               if(event.groundDetails){
			                ...
			                phtm+='</div>';	
			                   ...
			                   var  eventMatchMapId="'"+res.buddyCompletedMatchInvitationList[i].eventMatchMapId+"'";
			            	   var rosterId="'"+res.buddyCompletedMatchInvitationList[i].rosterId+"'";
			            	   var tournamentSchedulerId="'"+event.tournamentSchedulerId+"'";
			            	   var invitationacceptcountdisp="'invitationacceptcountdisp"+res.buddyCompletedMatchInvitationList[i].eventMatchMapId+"'";
			            	   var invitationmaybecountdisp="'invitationmaybecountdisp"+res.buddyCompletedMatchInvitationList[i].eventMatchMapId+"'";
			            	   var invitationrejectcountdisp="'invitationrejectcountdisp"+res.buddyCompletedMatchInvitationList[i].eventMatchMapId+"'";
			            	   
			            	   var playerId="'"+res.buddyCompletedMatchInvitationList[i].playerId+"'";
			            	   var accept="'acceptingMatches"+res.buddyCompletedMatchInvitationList[i].eventMatchMapId+"'";
     ...
     data:postinfo,			            
		success : function(res) {
					...
					if(res.buddyEventInvitationList!=null){
						...
						for(var i in upcomingevent){
							...
							var	maybediv="'invitationmaybecountdisp"+upcomingevent[i].eventId+"'";
								...
								htm +='<div class="col-md-6 threebtn">';
								htm +='<p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Reject" onclick="eventoption2('+eventid+',73,this,'+acceptdiv+')" id="inviteReject'+upcomingevent[i].eventId+'"><br>';
								...
								htm +='<p> <input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Accept"  onclick="eventoption2('+eventid+',71,this,'+rejectiv+')" id="inviteAccept'+upcomingevent[i].eventId+'"><br>';
								...
								htm +='<div class="col-md-6 threebtn">';
								htm +='<p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Reject" disabled="disabled" id="inviteReject'+upcomingevent[i].eventId+'"><br>';
								htm +='<a href="javascript:gettingEventAcceptedPeopleList('+eventid+','+reject+',143)">Rejected :'+upcomingevent[i].rejectedCount+' </a></p>';
			...
			if(pastindicate!=0){
				   ...
				   $('#buddyPastDivERROR').html('No Events');
			   }
			
			$('#buddyInvitationEventList').html(htm);
			$('#buddyInviationPaginationDIV').html(htm2);
			$('#buddyInvitationPastEventList').html(phtm);
		},
