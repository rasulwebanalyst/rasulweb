...
<div class="col-md-10">
      		<div class="col-md-12 whiteBox">
		          <h1 class="">Assign portal scorer to a schedule</h1>
                  <form id="filterForm" method="POST" action="${pageContext.request.contextPath}/filterForScheduleListAssignPortalScorerProfile.htm">
                  <div class="col-md-12 noPadding">
                 ...
                 <c:choose>
                  ...
                  <table id="myTableAssign" style="font-size: 12px;">
                                ...
                                <tr>
                                   ...
                                   <%--   <td><p id="formatDate_${tourDetails.tournamentSchedulerId}" style="display:none">                                     
                                     <fmt:formatDate pattern="M/d/YYYY hh:mm a" value="${tourDetails.gameDate}" /></p>
                                      <script>document.writeln(test("${tourDetails.tournamentSchedulerId}"));</script>                                     
                                     </td> --%>
                                ...
                                <tr>
                                  ...
                                  <td class="alignCenter">
                                         <!--  <a href="#" title="Edit"><i class="fa fa-pencil editIcon"></i></a> -->
                                          <a href="javascript:void(0)" onclick="deleteSorer('${scorer.scorerId}')" title="Delete"><i class="fa fa-trash-o deleteIcon"></i></a>
                                        </td>
                                  </c:forEach>	
                                   </tr>
...
<%@ include file ="Footer.jsp" %>
   ...
   function showScorerList(schedulerId, id){
	   ...
	   console.log(id);
		 ...
		 $.ajax({
			type:"Post",
			url:"${pageContext.request.contextPath}/showPortalScorerListInAssignUmpire",
			...
			success :function(res){
				...
				htmlContent += '<th>Portal Scorer</th>' ;
				...
				htmlContent += " <a href='javascript:void(0)' onclick='deleteScorer(\""+scorerId+"\",\""+schedulerId+"\")'  title='Delete'><i class='fa fa-trash-o deleteIcon'></i></a>" ;
				htmlContent += ' </td>' ;
				htmlContent += ' </tr>' ;
				}
	 ...
	 function deleteScorer(scorerId,schedulerId){
		 ...
		 $.ajax({		
			 type:"post",
			 url:"${pageContext.request.contextPath}/deletePortalScorerFromAssignPage",
			 headers : {'Name' : HeaderName},
			 data:JSON.stringify(bean),
			 contentType:"application/json; charset=utf-8",
			 success : function(res){
	 ...
	 function addScorer(){
		 ...
		 for(var i=0; i<scorerArray.length; i++){			
			  if(scorerId == scorerArray[i])
				 {
				$("#error").html("This user already assigned as portal scorer for this schedule");
				 return false;
				 }else{					 
				 }
		 }		 
		 ...
		 if(scorerId == 0){
			 $("#error").html("Please choose protal scorer name");
			// $("#error").fadeOut(3000);
		 }else{
		 var bean = {
				 userId : scorerId,
		 ...
		 $.ajax({				
			 type:"post",
			 url:"${pageContext.request.contextPath}/addPortalScorerFromAssignPage",
			 headers : {'Name' : HeaderName},
			 data:JSON.stringify(bean),
			 contentType:"application/json; charset=utf-8",
			 success : function(res){				 
