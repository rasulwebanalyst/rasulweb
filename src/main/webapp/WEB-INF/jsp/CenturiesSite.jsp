      ...
      <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
                 ...
                 <!--  <div class="h1Sbox">
                  ...
                  <form action="${pageContext.request.contextPath}/leaguecenturieslistSite" id="centuriesSearchForm" name="centuriesSearchForm" method="post" onsubmit="return searchValiation()">
                  <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
