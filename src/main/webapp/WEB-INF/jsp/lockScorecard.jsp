      		...
      		<div class="col-md-12 whiteBox">
                  ...
                  <div class="col-md-12 noPadding">
                        ...
                        <div class="fpDiv">
				            ...
				            <label for="r1"><span></span>All matches to be locked
                            ...
                            <label for="r2"><span></span>Select tournament to lock</label><br>
                
                     </div>
                        
                        <div id="accountRecoveryBoxId" style="display: none;">
                        ...
                        <div class="col-md-3 noLeftPad">
									<label for="">Select Tournaments</label> 
										<div class="selectdiv">
                        ...
                        <div class="col-md-3">
                        <label for="">From Date</label> <input type="text" class="form-control datepicker calIconImg" placeholder="" id="fromDate" name="fromDate" value="" onfocus="readOnlyFunction()"> 
                       ...
                       <!--    <i class="fa fa-calendar calIcon"></i> -->
                        ...
                        <div class="col-md-3">
                          <label for="">To Date</label> <input type="text" class="form-control datepicker calIconImg" placeholder="" id="toDate" name="toDate" value="" onfocus="readOnlyFunction()"> 
