...
//-->
var firstInningsBatting="${firstInningsBattingPlayer}";
var secondInningsBatting="${SecondInningsBattingPlayer}";
var firstInningsBowlingP="${firstInningsBowlingPlayer}";
var secondInningsBowling="${SecondInningsBowlingPlayer}";
 ...
 var homeTeamId = "${scoreCardList.homeTeamId}";
 var awayTeamId = "${scoreCardList.awayTeamId}";
 
 var firstInningsDob=0;
 var secondInningsDob=0;
 
//changed by vignesh
 //var homeTeamId = "${firstInnings.battingTeamId}";
 //var awayTeamId = "${firstInnings.bowlingTeamId}";
 
 
 var winTeamPoint = "${winPoint}";
 var scoreList="${scoreCardList}";
...
<div class="container">
    ...
    <div class="col-md-12 middleContBlock noPadding">
      ...
      <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
		          <h1 class="pageHead noBorder">Edit Score
                  
                  <div class="h1Sbox">                            
                                
                                <div class="selectdiv pull-right">
                                    <select class="selectboxdiv" id="scheduler" disabled="disabled">
                                        <option value="0">"${scoreList.homeTeamName}","${scoreList.awayTeamName}"</option> 
                                        
                                    </select>
                                    <div class="out" id="schedulerTextVal">"${scoreList.homeTeamName}","${scoreList.awayTeamName}"</div>    
                                </div>
                                
                                
                                <div class="selectdiv pull-right">
                                   
                                    <select class="selectboxdiv valid" id="tournament" disabled="disabled">
                                    ...
                                    <div class="out" id="tournamentTextVal">${tournaments.tournamentName}</div>    
                                </div>
                                <script type="text/javascript">
                           ...
                           <div class="h1Sbox inningSelectBox" >
                              ...
                              <div style="float: right;width: 45%; margin-right: 2%;">
                                ...
                                <div class="selectdiv" style="float: left; width: 100%; margin-left: 0;" >                                 
                                    <select class="selectboxdiv" id="awayTeamName" disabled="disabled" > 
                                    <option value="${firstInnings.bowlingTeamId}">${firstInnings.bowlingTeamName}</option>                
                                  <!-- <option value="0">"${scoreList.homeTeamName}","${scoreList.awayTeamName}"</option> 
                                    ...
                                    <div class="out" id="awayTeamNameOUT" >"${firstInnings.bowlingTeamName}"</div>  
                                ...
                                <div class="selectdiv" style="float: left; width: 100%; margin-left: 0;">                                 
                                    <select class="selectboxdiv" id="homeTeamName" disabled="disabled">
                                      <option value="${firstInnings.battingTeamId}">${firstInnings.battingTeamName}</option>                                     
                                    </select>
                                    <div class="out" id="homeTeamNameOUT">"${firstInnings.battingTeamName}"</div>
                                    <label class="error"></label>    
                                </div>
                                </div><!-- div end -->                                	
                              </div>
                              <div style="margin-top: 33px;">
                              	<input type="text" value="${scoreCardList.gameDate}" id="matchDate" style="height: 36px;" readonly>
                              	<button onclick="matchEdit('${homeTeamId}','${awayTeamId}')" class="btn btn-default dBtn" style="margin-left: 6px;" id="enterscoreStartbtn" >Edit score</button> <a href="#" style="margin-left: 6px;width: 98px;" class="btn btn-default dBtn" onclick="cancelValues()">Cancel</a>
        ...
        <section id="cslide-slides" class="cslide-slides-master clearfix">
 		 ...
 		 <table class = "firInnBatting" id="firInnBattingTable">
            ...
            <tbody>
            <c:forEach var="firstBatting" items="${firstInningsBattingPlayer}" varStatus="loop">
            <tr>
					<td>					
					<select style="width:100px" id="firInnPlayerName_${loop.index}" name="firInnPlayerName_${loop.index}" onchange="firstIningsbattingPlayerOnchange(this,'addMemberIDDIV${loop.index}','FistInningBatting')">
					  ...
					  <option selected="selected" value="${battinglist.userId}">${battinglist.userProfile.fullName}</option>
					  </c:when>
					  <c:otherwise>
					  <option  value="${battinglist.userId}">${battinglist.userProfile.fullName}</option>
					  </c:otherwise>
					  </c:choose>
					</c:forEach>  
					</select>					
            	...
            	<div class="autoComplete" id="addMemberautoCompleteDIV" style="display:none;">
                                  ...
                                  <input type="hidden" class="addMemberIDDIV" class="form-control" placeholder="" id="addMemberIDDIV${loop.index}" name="addMemberIDDIVName" >
                </td>
                ...
                <td><div class="amdSbox">
                           ...
                           <div class="selectdiv" style="width:121px">
                            ...
                            <input type="hidden" class="wid" id="firInnDismissal_${loop.index}" name="firInnDismissal" >
                 </td>
                ...
                <td>
									<select style="width:100px" id="firInnFielderName_${loop.index}" name="firInnFielderName_${loop.index}" onchange="firstIningsbattingPlayerOnchange1(this,'addMemberIDDIVFiel${loop.index}')">
													
								<option value="0">Select Player</option>					
					<c:forEach var="bowlinglist" items="${awayTeamRosterList1}" >
					  <c:choose>
					  <c:when test="${firstBatting.fielderId eq bowlinglist.userId}">
					  <option selected="selected" value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
					  </c:when>
					  <c:otherwise>
					  <option  value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
					  </c:otherwise>
					  </c:choose>
					</c:forEach> 
					</select>		         
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVFiel${loop.index}" name="addMemberIDDIVFiel" >
                </td>
                 ...
                 <td>
					...
					<c:forEach var="bowlinglist" items="${awayTeamRosterList1}" >
					  <c:choose>
					  <c:when test="${firstBatting.battingWicketTakenBy eq bowlinglist.userId}">
					  <option selected="selected" value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
					  </c:when>
					  <c:otherwise>
					  <option  value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
                ...
                <td><input type="text" class="wid OnlyNumber" id="firInnRuns_${loop.index}" onfocus = "numberCheck(this)" name="firInnRuns" onblur="calculateStrikerate('firInnRuns_${loop.index}','firInnBalls_${loop.index}','firInnStrikeRate_${loop.index}')" value="${firstBatting.battingRuns}"></td>
                <td><input type="text" class="wid OnlyNumber" id="firInnBalls_${loop.index}" onfocus = "numberCheck(this)" name="firInnBalls" value="${firstBatting.battingBallnumber}" onblur="calculateStrikerate('firInnRuns_${loop.index}','firInnBalls_${loop.index}','firInnStrikeRate_${loop.index}')"></td>
                <td><input type="text" class="wid OnlyNumber" id="firInnFours_${loop.index}" onfocus = "numberCheck(this)" name="firInnFours" value="${firstBatting.battingFours}"></td> 
                <td><input type="text" class="wid OnlyNumber" id="firInnSixs_${loop.index}"  onfocus = "numberCheck(this)" name="firInnSixs" value="${firstBatting.battingSix}"></td> 
                <td><input type="text" class="wid OnlyNumber" id="firInnBattingOvers_${loop.index}" onfocus = "numberCheck(this)" name="firInnBattingOvers" value=""></td>
                <td><input type="text" class="wid " id="firInnMins_${loop.index}" onfocus = "numberCheck(this)" name="firInnMins" value="${firstBatting.minutes}"></td>
                <td><input type="text" class="wid" id="firInnStrikeRate_${loop.index}" onfocus = "numberCheck(this)" name="firInnStrikeRate" readonly="readonly" value="${firstBatting.battingStrikeRating}"></td>   
  ...
  <br>
  <div><a href="javascript:void(0)" class="enterScoreAddMore" onclick="addFirstInningsBatting()">Add More</a>
  
  
    <a id="removebattingrow" href="javascript:void(0)" class="enterScoreAddMore" onclick="removeFirstInningsBatting('first')" style="display: none;">Remove</a>
  </div><br><br>
  ...
  <div class="pull-left score-details-table-holder">
  	...
  	<tr>
  	 <td><input type="text" id="firstInningsWide" value="${firstInnwide}"></td> 
  	<td><input type="text" id="firstInningsNoBalls" value="${firstInnnoBalls}"></td>
  	<td><input type="text" id="firstInningsByes" value="${firstInnbyes}"></td>
  	<td><input type="text" id="firstInningsLegByes" value="${firstInnlegByes}"></td>
  	<td><input type="text" id="firstInningsPenalties" value="${firstInnpenalties}"></td>  	
  	</tr>
  	...
  	<div class="score-details-in">		
        ...
        <input type="text" class="TOT-E OnlyNumber" id="firstInnigsScore" onfocus="numberCheck(this);" onblur="firstInningsTotalScore(this.value)" value="${firstInnings.firstInningsTotalRuns}">
        <label for="email" class="totscor">TOTAL WICKET</label>
        <input type="text" class="TOT-E OnlyNumber" id="firstInnigsTotalWicket" onfocus="numberCheck(this);" onblur="firstInningsWickets(this.value)" value="${firstInnings.totalWickets}">
        <label for="text" class="totscor">TOTAL OVER</label>
        <input type="text" class="TOT-E" id="firstBattingTotalOvers" onfocus="numberCheck(this);" onblur="firstInningsTotalOversChange()" value="${firstInnings.totalOvers}">
  ...
  <table class="score-table">
  	<tr>
  	<td>1</td><td><input type="text" id="firstInningsFirstWicket" value="${firstInn1stWicket}"></td>
  	<td>2</td><td><input type="text" id="firstInningsSecondWicket" value="${firstInn2ndWicket}"></td>
  	<td>3</td><td><input type="text" id="firstInningsThirdWicket" value="${firstInn3rdWicket}"></td>
  	<td>4</td><td><input type="text" id="firstInningsFourthWicket" value="${firstInn4thWicket}"></td>
  	<td>5</td><td><input type="text" id="firstInningsFithWicket" value="${firstInn5thWicket}"></td>
  	<td>6</td><td><input type="text" id="firstInningsSixthWicket" value="${firstInn6thWicket}"></td>
  	<td>7</td><td><input type="text" id="firstInningsSevenWicket" value="${firstInn7thWicket}"></td>
  	<td>8</td><td><input type="text" id="firstInningsEightWicket" value="${firstInn8thWicket}"></td>
  	<td>9</td><td><input type="text" id="firstInningsNineWicket" value="${firstInn9thWicket}"></td>
  	<td>10</td><td><input type="text" id="firstInningsTendWicket" value="${firstInn10thWicket}"></td>
  </tr>
...
<option value="AL">Albania</option>
  ...
  <table id="firInnBowlingTable" style="margin-top: 1%;">
  		<thead>
            ...
            <tbody>
           <c:forEach var="firstInnBowling" items="${firstInningsBowlingPlayer}" varStatus="loop">
            <tr>
            
            	
								
								<td>		
								<select  id="firInnBowlingName_${loop.index}" name="firInnBowlingName_${loop.index}" size="1" onchange="firstIningsbattingPlayerOnchange(this,'addMemberIDDIVBowling${loop.index}','FirstInningBowling')">
												
												
					<c:forEach var="bowlinglist" items="${awayTeamRosterList1}" >
					  <c:choose>
					  <c:when test="${firstInnBowling.playerId eq bowlinglist.userId}">
					  <option selected="selected" value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
					  </c:when>
					  <c:otherwise>
					  <option  value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
                                  ...
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVBowling${loop.index}" name="addMemberIDDIVBowling">
            	</td>
                ...
                <td><input type="text" value="${firstInnBowling.bowlingFours}" class="wid OnlyNumber" id="firInnBowFours_${loop.index}" onfocus = "numberCheck(this)" name="firInnBowFours"></td>
                <td><input type="text" value="${firstInnBowling.bowlingSix}" class="wid OnlyNumber" id="firInnBowSixs_${loop.index}" onfocus = "numberCheck(this)" name="firInnBowSixs"></td>    
                 <td><input type="text" value="${firstInnBowling.bowlingBallNumber}" class="wid OnlyNumber" id="firInnBowBalls_${loop.index}" onfocus = "numberCheck(this)" name="firInnBowBalls" readonly="readonly"></td>           
   ...
   <a id="removefirstbowling" class="enterScoreAddMore" href="javascript:void(0)" onclick="removeInningBowling('first')" style="display: none;">Remove</a>
   ...
   <input type="text"  id="" readonly="readonly" style="height: 0; width: 0; opacity : 0;">
 		 ...
 		 <table id="secInnBattingTable">
            ...
            <c:forEach var="secondBatting" items="${SecondInningsBattingPlayer}" varStatus="loop">
			 <tr>
            	<td>
					...
					<c:forEach var="battinglist" items="${awayTeamRosterList1}" >
					  ...
					  <option  value="${battinglist.userId}">${battinglist.userProfile.fullName}</option>
                                  ...
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVPlayer${loop.index}" name="addMemberIDDIVPlayer">
            	...
            	<td><div class="amdSbox">
                           ...
                           <input type="hidden" class="wid" id="secInnDismissal_${loop.index}">
                       </td>
                ...
                <select style="width:100px" id="secInnFielderName_${loop.index}" name="secInnFielderName_${loop.index}" onchange="firstIningsbattingPlayerOnchange1(this,'addMemberIDDIVFielderSec${loop.index}')">
                
                <option value="0">Select Player</option>					
					<c:forEach var="bowlinglist" items="${homeTeamRosterList1}" >
					  <c:choose>
					  <c:when test="${secondBatting.fielderId eq bowlinglist.userId}">
					  <option selected="selected" value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
					  </c:when>
					  <c:otherwise>
					  <option  value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
                                  ...
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVFielderSec${loop.index}" name="addMemberIDDIVFielderSec">
                 ...
                 <td>
					...
					<c:forEach var="bowlinglist" items="${homeTeamRosterList1}" >
					  ...
					  <option  value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
                                  ...
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVBowlerSec${loop.index}" name="addMemberIDDIVBowlerSec">
                
                </td>
				
                <td><input type="text" value="${secondBatting.battingRuns}" class="wid OnlyNumber" id="secInnRuns_${loop.index}" onfocus = "numberCheck(this)" name="secInnRuns" onblur="calculateStrikerate('secInnRuns_${loop.index}','secInnBalls_${loop.index}','secInnStrikeRate_${loop.index}')"></td>
                <td><input type="text" value="${secondBatting.battingBallnumber}" class="wid OnlyNumber" id="secInnBalls_${loop.index}" onfocus = "numberCheck(this)" name="secInnBalls" onblur="calculateStrikerate('secInnRuns_${loop.index}','secInnBalls_${loop.index}','secInnStrikeRate_${loop.index}')"></td>
                <td><input type="text" value="${secondBatting.battingFours}" class="wid OnlyNumber" id="secInnFours_${loop.index}" onfocus = "numberCheck(this)" name="secInnFours"></td>        
                <td><input type="text" value="${secondBatting.battingSix}" class="wid OnlyNumber" id="secInnSixs_${loop.index}" onfocus = "numberCheck(this)" name="secInnSixs"></td>           
                <td><input type="text" value="" class="wid OnlyNumber" id="secInnBattingOvers_${loop.index}" onfocus = "numberCheck(this)" name="secInnBattingOvers"></td>
                <td><input type="text" value="${secondBatting.minutes}" class="wid" id="secInnMins_${loop.index}" onfocus = "numberCheck(this)" name="secInnMins"></td>               
                <td><input type="text" value="${secondBatting.battingStrikeRating}" class="wid" id="secInnStrikeRate_${loop.index}" onfocus = "numberCheck(this)" name="secInnStrikeRate" readonly="readonly"></td>    
   ...
   <div><a class="enterScoreAddMore" href="javascript:void(0)" onclick="addSecondInningsBatting()">Add More</a>
   
   <a id="removesecondbattingrow" href="javascript:void(0)" class="enterScoreAddMore" onclick="removeFirstInningsBatting('second')" style="display: none;">Remove</a>
  ...
  <div class="pull-left score-details-table-holder">
  	...
  	<tr><td><input type="text" id="secondInningsWide" value="${secondInnwide}"></td>
  	<td><input type="text" id="secondInningsNoBalls" value="${secondInnnoBalls}"></td>
  	<td><input type="text" id="secondInningsByes" value="${secondInnbyes}"></td>
  	<td><input type="text" id="secondInningsLegByes" value="${secondInnlegByes}"></td>
  	<td><input type="text" id="secondInningsPenalties" value="${secondInnpenalties}"></td>
  	</tr>
  	</table>
  	<div class="score-details-in">		
    	<label for="email" class="totscor">TOTAL SCORE</label>
        <input type="text" value="${secondInnings.secondInningsTotalRuns}" class="TOT-E OnlyNumber" id="secondInnigsScore" onfocus="numberCheck(this);" onblur="secondInningsTotalScore(this.value)">
        <label for="email" class="totscor">TOTAL WICKET</label>
        <input type="text" value="${secondInnings.totalWickets}" class="TOT-E OnlyNumber" id="secondInnigsTotalWicket" onfocus="numberCheck(this);" onblur="secondInningsWickets(this.value)">
         <label for="text" class="totscor">TOTAL OVER</label>
        <input type="text" value="${secondInnings.totalOvers}" class="TOT-E" id="secondBattingTotalOvers" onfocus="numberCheck(this);" onblur="secondInningsTotalOversChange()">
  	</div><!-- score details in end -->	
  </div><!-- score-details-table-holder end -->
  ...
  <table class="score-table">
  	<tr>  	
  	<td>1</td><td><input type="text" id="scondInningsFirstWicket" value="${secondInn1stWicket}"></td>  	
  	<td>2</td><td><input type="text" id="scondInningsSecondWicket" value="${secondInn2ndWicket}"></td>
  	<td>3</td><td><input type="text" id="scondInningsThirdWicket" value="${secondInn3rdWicket}"></td>
  	<td>4</td><td><input type="text" id="scondInningsFourthWicket" value="${secondInn4thWicket}"></td>
  	<td>5</td><td><input type="text" id="scondInningsFithWicket" value="${secondInn5thWicket}"></td>
  	<td>6</td><td><input type="text" id="scondInningsSixthWicket" value="${secondInn6thWicket}"></td>
  	<td>7</td><td><input type="text" id="scondInningsSevenWicket" value="${secondInn7thWicket}"></td>
  	<td>8</td><td><input type="text" id="scondInningsEightWicket" value="${secondInn8thWicket}"></td>
  	<td>9</td><td><input type="text" id="scondInningsNineWicket" value="${secondInn9thWicket}"></td>
  	<td>10</td><td><input type="text" id="scondInningsTendWicket" value="${secondInn10Wicket}"></td>  
  </tr>
            ...
            <tr>
            	<td>
							<select id="secInnBowlingName_${loop.index}" name="secInnBowlingName_${loop.index}" onchange="firstIningsbattingPlayerOnchange(this,'addMemberIDDIVBowlingSec${loop.index}','SecondInningBowling')">
								               ...
								               <c:forEach var="bowlinglist" items="${homeTeamRosterList1}" >
					  <c:choose>
					  <c:when test="${secondBowling.playerId eq bowlinglist.userId}">
					  <option selected="selected" value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
					  </c:when>
					  <c:otherwise>
					  <option  value="${bowlinglist.userId}">${bowlinglist.userProfile.fullName}</option>
                                  ...
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVBowlingSec${loop.index}" name="addMemberIDDIVBowlingSec">
            	
            	</td>
                <td><input type="text" value="${secondBowling.bowlingOvers}" class="wid" id="secInnOvers_${loop.index}" onfocus = "numberCheck(this)" name="secInnOvers" onblur="calculateBowlingEconamic('secInnBowRuns_${loop.index}','secInnOvers_${loop.index}','secInnEco_${loop.index}','secInnBowBalls_${loop.index}')"></td>
                <td><input type="text" value="${secondBowling.bowlingRuns }" class="wid OnlyNumber" id="secInnBowRuns_${loop.index}" onfocus = "numberCheck(this)" name="secInnBowRuns" onblur="calculateBowlingEconamic('secInnBowRuns_${loop.index}','secInnOvers_${loop.index}','secInnEco_${loop.index}','secInnBowBalls_${loop.index}')"></td>
				<td><input type="text" value="" class="wid OnlyNumber" id="secInnMaiden_${loop.index}" onfocus = "numberCheck(this)" name="secInnMaiden"></td>
                <td><input type="text" value="${secondBowling.wickets }" class="wid OnlyNumber" id="secInnWickets_${loop.index}" onfocus = "numberCheck(this)" name="secInnWickets"></td>
                <td><input type="text" value="${secondBowling.bowlingEconomyRate }" class="wid" id="secInnEco_${loop.index}" onfocus = "numberCheck(this)" name="secInnEco" readonly="readonly"></td>
                <td><input type="text" value="${secondBowling.bowlingZeros }" class="wid OnlyNumber" id="secInnZeros_${loop.index}" onfocus = "numberCheck(this)" name="secInnZeros"></td>
                <td><input type="text" value="${secondBowling.bowlingFours }" class="wid OnlyNumber" id="secInnBowFours_${loop.index}" onfocus = "numberCheck(this)" name="secInnBowFours"></td>
                <td><input type="text" value="${secondBowling.bowlingSix }" class="wid OnlyNumber" id="secInnBowSixs_${loop.index}" onfocus = "numberCheck(this)" name="secInnBowSixs"></td> 
                <td><input type="text" value="${secondBowling.bowlingBallNumber }" class="wid OnlyNumber" id="secInnBowBalls_${loop.index}" onfocus = "numberCheck(this)" name="secInnBowBalls" readonly="readonly"></td>                  
                </tr>
                </c:forEach>
            </tbody>
  </table><br>
                  ...
                  <a id="removesecondbowling" class="enterScoreAddMore" href="javascript:void(0)" onclick="removeInningBowling('second')" style="display: none;">Remove</a>
                    ...
                    <form role="form" id="enterScoreform" name="enterScoreform">
                    	...
                    	<div class="form-group">
                          ...
                          <div class="sfLeft">
                            ...
                            <div class="sfRight">
                            <input type="text" placeholder="" class="form-control tbox fomtexbox" id="PlayerOfTheMatch" value="${PlayerOfTheMatch.userName}" onkeyup="normalUserSearch(this,'addMemberautoCompleteDIVPlayerOfMatch','addMemberIDDIVPlayerOfMatch')" >
                            ...
                            <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVPlayerOfMatch" name="addMemberIDDIVPlayerOfMatch" value="${PlayerOfTheMatch.userId}">
                          ...
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1">Home team coach</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" class="form-control fomtexbox" id="homeTeamcoach" value="${scoreCardList.homeTeamCoach}" onkeyup="normalUserSearch(this,'addMemberautoCompleteDIVHomeCoach','addMemberIDDIVHomeCoach')">
                            <div class="autoComplete" id="addMemberautoCompleteDIVHomeCoach" style="display:none;">
													<ul>
			                                        	<li></li>
			                                        </ul>                                  	
			                                  </div> 
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVHomeCoach" name="" value="${scoreCardList.homeTeamCoachId}">
                          </div></div>
                          ...
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1">Away team coach</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" class="form-control fomtexbox" id="awayTeamCoach" value="${scoreCardList.awayTeamCoach}" onkeyup="normalUserSearch(this,'addMemberautoCompleteDIVAwayCoach','addMemberIDDIVAwayCoach')">
                            <div class="autoComplete" id="addMemberautoCompleteDIVAwayCoach" style="display:none;">
													<ul>
			                                        	<li></li>
			                                        </ul>                                  	
			                                  </div> 
                                  <input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVAwayCoach" name="" value="${scoreCardList.awayTeamCoachId}">
                          </div></div>
                          ...
                          <!--  <div id="showHideDiv" style="display:none"> --> 
                           ...
                           <div class="form-group">
				            ...
				            <label class="fomlabel" for="r1" id="homeTeamOvers">Win Team Overs</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder=""  value="${scoreCardList.homeTeamOvers}" class="form-control tbox fomtexbox" id="winTeamOvers" name="winTeamOvers" onfocus = "numberCheck(this)" readonly="readonly"/>
                          ...
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1" id="homeTeamPoints">Win Team Points</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" value="${scoreCardList.homeTeamPoints}" class="form-control tbox fomtexbox OnlyNumber" id="winTeamPoints" onfocus = "numberCheck(this)" name="winTeamPoints" readonly="readonly"/>
                          </div></div>
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1" id="homeTeamRuns">Win Team Runs</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" value="${scoreCardList.homeTeamRuns}" class="form-control tbox fomtexbox OnlyNumber" id="winTeamRuns" onfocus = "numberCheck(this)" name="winTeamRuns"  readonly />
                          </div></div>
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1" id="homeTeamWickets">Win Team Wickets</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" value="${scoreCardList.homeTeamWickets}" class="form-control tbox fomtexbox OnlyNumber" id="winTeamWickets" onfocus = "numberCheck(this)" name="winTeamWickets" readonly="readonly" />
                          </div></div>
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1" id="awayTeamOvers">lose Team Overs</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" value="${scoreCardList.awayTeamOvers}" class="form-control tbox fomtexbox" id="loseTeamOvers" onfocus = "numberCheck(this)" name="loseTeamOvers" readonly="readonly" />
                          </div></div>
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1" id="awayTeamRuns">lose Team Runs</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" value="${scoreCardList.awayTeamRuns}" class="form-control tbox fomtexbox OnlyNumber" id="loseTeamRuns" onfocus = "numberCheck(this)" name="loseTeamRuns" readonly />
                          </div></div>
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1" id="awayTeamPoints">lose Team Points</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" value="${scoreCardList.awayTeamPoints}" class="form-control tbox fomtexbox OnlyNumber" id="loseTeamPoints" onfocus = "numberCheck(this)" name="loseTeamPoints"  readonly="readonly"/>
                          </div></div>
                          <div class="form-group">
                           <div class="sfLeft">
				            <label class="fomlabel" for="r1" id="awayTeamWickets">lose Team Wickets</label>
				             ...
				             <div class="sfRight">
                            <input type="text" placeholder="" value="${scoreCardList.awayTeamWickets}" class="form-control tbox fomtexbox OnlyNumber" id="loseTeamWickets" onfocus = "numberCheck(this)" name="loseTeamWickets"  readonly="readonly"/>
                          </div></div>
                          <div class="form-group">
                           <div class="sfLeft">
...
$(document).ready(function(){
	...
	//}
     	...
     	//document.getElementById("tournament").value = "${selectedTournamentId}";
   ...
   function loadScheduler(val){
    ...
    function teamName(val){
	  ...
	  // document.getElementById("homeTeamName").innerHTML = homeTeam+ " (1st Innings)";
	   ...
	   var html ='';
		/* html += '<select class="selectboxdiv" id="result" name="result" onchange="winpointAutoPopulate();">';
 	   ...
 	   $('#firInnBattingTable tbody tr:last  td select').each(function(){
          ...
          var htmlContentFirstInningsBowlers = '<select style="width:100px" id="firInnBowlerName_'+count+'" name="firInnBowlerName_'+count+'" onchange=firstIningsbattingPlayerOnchange1(this,"addMemberIDDIVBow'+count+'")>';
		      ...
		      // cell4.innerHTML = '<div class="amdSbox"><div class="selectdiv" style="width:147px"><select class="selectboxdiv"  id="dissmissalType'+count+'" name="dismissalType" onchange=selectDismissal(this,"firInnDismissal_'+count+'")><option value="0">Select dissmissal type</option><c:forEach var="dismissal" items="${dismissalTypeList}"><option value="${dismissal.dismissalTypeId}">${dismissal.dismissalTypeName}</option></c:forEach>  </select><div  class="out">Select dissmissal type</div></div></div><input type="hidden" class="wid" id="firInnDismissal_'+count+'">';
		       ...
		       cell5.innerHTML = '<input type="text" class="wid OnlyNumber" id="firInnRuns_'+count+'" onfocus = "numberCheck(this)" name="firInnRuns" onblur=calculateStrikerate("firInnRuns_'+count+'","firInnBalls_'+count+'","firInnStrikeRate_'+count+'") onkeyup=calculateruns("firInnRuns_'+count+'","firInnFours_'+count+'","firInnSixs_'+count+'","Totalruns")>';
		   ...
		   var htmlContentFirstInningsFeilders =  '<select style="width:100px"  id="secInnFielderName_'+count1+'"  name="secInnFielderName_'+count1+'" onchange=firstIningsbattingPlayerOnchange1(this,"addMemberIDDIVFielderSec'+count1+'")>';   
              ...
              htmlContentFirstInningsFeilders += '</select><input type="hidden" class="form-control" placeholder="" id="addMemberIDDIVFielderSec'+count1+'" name="addMemberIDDIVFielderSec">';	     
		       cell3.innerHTML = htmlContentFirstInningsFeilders;
			       ...
			       cell5.innerHTML = '<input type="text" class="wid OnlyNumber" id="secInnRuns_'+count1+'" onfocus = "numberCheck(this)" name="secInnRuns" onblur=calculateStrikerate("secInnRuns_'+count1+'","secInnBalls_'+count1+'","secInnStrikeRate_'+count1+'") onkeyup=calculateruns("secInnRuns_'+count1+'","secInnFours_'+count1+'","secInnSixs_'+count1+'","Totalruns")>';
...
var SecondInningsScore = $("#secondInnigsScore").val();
   ...
   // alert("score card"+JSON.stringify(scorerBean));
		...
		url:"${pageContext.request.contextPath}/editScoreInsert",
		headers : {'Name' : HeaderName},
...
function setDonotBatPlayersFirstInnings(){
	...
	if(	$("#awayTeamName").val() == firstTeamPlayersId[0].boardId){
		...
		firstInningsDob = 0;
		var dnb=${firstInningsDNB};
		var dnblist=[];
		for(var i in dnb){
			dnblist.push(dnb[i].userId);
		}
		...
		if(	$("#awayTeamName").val() == firstTeamPlayersId[0].boardId){
			for(var i =0;i<sceondTeamPlayersId.length;i++ ){
			   ...
			   if(dnblist.indexOf(sceondTeamPlayersId[i].userId) == -1)
			   {
			   htmlContent += '<option value="'+sceondTeamPlayersId[i].userId+'">'+sceondTeamPlayersId[i].userProfile.fullName+'</option>';
			   }
			   else{
				   htmlContent += '<option selected="selected" value="'+sceondTeamPlayersId[i].userId+'">'+sceondTeamPlayersId[i].userProfile.fullName+'</option>';
			   }
			...
			for(var i =0;i<firstTeamPlayersId.length;i++ ){
				...
				if(firstInningsBatting.indexOf(firstTeamPlayersId[i].userId) == -1){
					...
					if(dnblist.indexOf(firstTeamPlayersId[i].userId) == -1)
					   {	
				htmlContent += '<option value="'+firstTeamPlayersId[i].userId+'">'+firstTeamPlayersId[i].userProfile.fullName+'</option>';
				}else{
					
					htmlContent += '<option  selected="selected" value="'+firstTeamPlayersId[i].userId+'">'+firstTeamPlayersId[i].userProfile.fullName+'</option>';
				}
	            }		  
			}
...
function selectPlayers(){
 var values = $("#dntPlayerList").val();
 console.log("values "+values);
 console.log("vv--"+JSON.stringify(values));
 alert("values"+values);
}
function firstInngingsBowlSelction(){
firstInninBowlingArrayList = [];
		 
		 
		 
		 $('#firInnBowlingTable tbody tr:last  td select').each(function(){
			   var name=$(this).attr("name");
			   var id=$(this).attr("id");
			 console.log('name ----> '+id);
			   if($(this).val() == ''){
				  false;
				   ...
				   if(name=='firInnBowlingName'){
					   firstInninBowlingArrayList.push($(this).val());
...
var firstInnId="${firstInnings.battingTeamId}";
var secInnId="${firstInnings.bowlingTeamId}";

console.log("firstInnId :"+firstInnId)

$("#hiddenHomeId").val(firstInnId);
$("#hiddenAwayId").val(secInnId);
