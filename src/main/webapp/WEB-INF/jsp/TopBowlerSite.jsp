      ...
      <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
		        <div class="col-md-10">    <h1 class="pageHead noBorder">Top Bowler
                  ...
                  <form action="${pageContext.request.contextPath}/leagueTopBowlerListSite" id="centuriesSearchForm" name="centuriesSearchForm" method="post" onsubmit="return searchValiation()">
                  <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
				                       ...
				                       <tbody id="topBowlerTableBody">
				                        <tr>
			                        		  <td></td>
	                       				  	 ...
	                       				  	 <img alt="" src="${player.userImageUrl}"onError="this.onerror=null;this.src='${pageContext.request.contextPath}/images/profileIcon.png';" ><b><a href="javascript:void(0);" onclick="PleaseLogin()">${player.userName}</a></b><div class="clearfix"></div></a></td>	                      					  
  		  							...
  		  							for (var j=0;j<mat.length;j++){
  		  	   							...
  		  	   							if(plist != null){
  		  	   								...
  		  	   								if(plist[k].userImageUrl != null && plist[k].userImageUrl != ""){
  		  	   									...
  		  	   									html += '<td class="tdAlignLeft TB_table"><a href="${pageContext.request.contextPath}/buddy/'+ plist[k].userName+ '/' +plist[k].userId+ '"><img alt="" src="'+plist[k].userImageUrl+'" ><b><a href="javascript:void(0);" onclick="PleaseLogin()">' +plist[k].userName+ '</a></b><div class="clearfix"></div></a></td>';
  		  	   								}else
  		  	   									{html += '<td class="tdAlignLeft TB_table"><a href="${pageContext.request.contextPath}/buddy/'+ plist[k].userName+ '/' +plist[k].userId+ '"><img alt="" src=${pageContext.request.contextPath}/images/profileIcon.png; ><b><a href="javascript:void(0);" onclick="PleaseLogin()">' +plist[k].userName+ '</a></b><div class="clearfix"></div></a></td>';}
