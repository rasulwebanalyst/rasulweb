    ...
    <div class="col-md-12 middleContBlock noPadding">
      ...
      <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
                 ...
                 <form action="${pageContext.request.contextPath}/leagueTopFiveWicketsListSite" id="centuriesSearchForm" name="centuriesSearchForm" method="post" onsubmit="return searchValiation()">  
                  <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
                                            ...
                                            <%-- <c:if test="${fiveWicket.size ne 0}"> --%>
                                                <tr>
                                                    ...
                                                    <%-- <c:choose>
                                                        ...
                                                        <td></td>
                                                        <td class="tdAlignLeft"><a href="${pageContext.request.contextPath}/buddy/${player.userName}/${player.userId}"><span class="text-danger"><img alt="" src="${player.userImageUrl}"onError="this.onerror=null;this.src='${pageContext.request.contextPath}/images/profileIcon.png';" width="30px" style="margin-right: 10px;"></span><b><a href="javascript:void(0);" onclick="PleaseLogin()">${player.userName}</a></b> </a></td>
                                                       ...
                                                       <%--  <td><a href="${pageContext.request.contextPath}/${player.homeTeamName}/board/${player.homeTeamId}">${player.homeTeamName}</a></td>
                                                        <td><a href="${pageContext.request.contextPath}/${player.awayTeamName}/board/${player.awayTeamId}">${player.awayTeamName}</a> </td>
                                                         --%>
                                                         <td class="tdAlignLeft"><a href="${pageContext.request.contextPath}/${player.homeTeamName}/board/${player.homeTeamId}"><img 	src="${player.homeTeamImgUrl}"onError="this.onerror=null;this.src='${pageContext.request.contextPath}/images/boardIcon.png';" style="width: 30px;margin-right: 10px; "><a href="javascript:void(0);" onclick="PleaseLogin()">${player.homeTeamName}</a></a></td>

														<td class="tdAlignLeft"><a href="${pageContext.request.contextPath}/${player.awayTeamName}/board/${player.awayTeamId}"><img src="${player.awayTeamImgUrl}"onError="this.onerror=null;this.src='${pageContext.request.contextPath}/images/boardIcon.png';" style="width: 30px;margin-right: 10px; "><a href="javascript:void(0);" onclick="PleaseLogin()">${player.awayTeamName}</a></a> </td>
