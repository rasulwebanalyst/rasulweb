...
<div class="container">
 ...
 <%-- <%@ include file="BoardFanMenu.jsp" %>  --%>
       ...
       <form action="${pageContext.request.contextPath}/public/LeaguePointsPagesite" id="centuriesSearchForm" name="centuriesSearchForm" method="post" onsubmit="return searchValiation()">
      <div class="col-md-10">
