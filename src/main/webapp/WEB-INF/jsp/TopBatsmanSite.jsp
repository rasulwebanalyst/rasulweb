		        ...
		        <div class="col-md-10">  <h1 class="pageHead noBorder">Top Batsman
                 ...
                 <!--  <div class="h1Sbox">
                  ...
                  <div class="col-md-2 col-sm-12 col-xs-12" style="display: inline-block;">
                   ...
                   <form action="${pageContext.request.contextPath}/leagueTopBatsmanListSite" id="centuriesSearchForm" name="centuriesSearchForm" method="post" onsubmit="return searchValiation()">
                  <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
                        	...
                        	<c:choose>
            					<c:when test="${topplayer.size eq 0}">
	                       		...
	                       		<tr>                        				 	
	                        				  	  ...
	                        				  	  <td class="tdAlignLeft TB_table"><a href="${pageContext.request.contextPath}/buddy/${player.userName}/${player.userId}"><img alt="" src="${player.userImageUrl}"onError="this.onerror=null;this.src='${pageContext.request.contextPath}/images/profileIcon.png';" "><b><a href="javascript:void(0);" onclick="PleaseLogin()">${player.userName}</a></b><div class="clearfix"></div></a></td>	 
   	   						...
   	   						if(mat != null){
   	   							for (var j=0;j<mat.length;j++){
   	   	   							...
   	   	   							if(plist[k].userImageUrl != null && plist[k].userImageUrl != ""){
   	   	   								html += '<td class="tdAlignLeft TB_table"><a href="${pageContext.request.contextPath}/buddy/'+ plist[k].userName+ '/' +plist[k].userId+ '"><img alt="" src="'+plist[k].userImageUrl+'" ></div><b><a href="javascript:void(0);" onclick="PleaseLogin()">' +plist[k].userName+ '</a></b><div class="clearfix"></div></a></td>';
   	   	   							}else
   	   	   								{
   	   	   						html += '<td class="tdAlignLeft TB_table"><a href="${pageContext.request.contextPath}/buddy/'+ plist[k].userName+ '/' +plist[k].userId+ '"><img alt="" src=${pageContext.request.contextPath}/images/profileIcon.png; ></div><b><a href="javascript:void(0);" onclick="PleaseLogin()">' +plist[k].userName+ '</a></b><div class="clearfix"></div></a></td>';
   	   	   								}
   	   	   								
   	   	   								html += '<td class="tdAlignLeft TB_table"><a href="${pageContext.request.contextPath}/' + plist[k].teamBoardInfo.boardName + '/board/' + plist[k].teamBoardInfo.boardId + '"><img src="'+plist[k].teamBoardInfo.boardImageURL+ '"><b><a href="javascript:void(0);" onclick="PleaseLogin()">' + plist[k].teamBoardInfo.boardName + '</a></b><div class="clearfix"></div></a></td>';
