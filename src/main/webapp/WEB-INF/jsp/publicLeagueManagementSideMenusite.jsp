                                ...
                                <div class="leftMenu2">
                                    	...
                                    	<ul>
                                           ...
                                           <c:if test="${!empty LeaugeMenuList}">
                                            ...
                                            <li><a href="${pageContext.request.contextPath}/UmpireProfilesite/${BoradInfo.boardId}"><i class="fa fa-angle-right"></i><span> Umpire List</span></a></li>
                                            
                                            <li class="head"><a href="#">Ground Co-ordinator</a></li>
                                            
                                            <li><a href="${pageContext.request.contextPath}/GroundProfilesite/${BoradInfo.boardId}"><i class="fa fa-angle-right"></i><span> Ground List</span></a></li>
