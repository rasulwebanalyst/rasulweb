    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header pull-left">
               ...
               <div class="topSearch">
                     <input id="buddySearchboxDiv"  type="text" class="form-control" placeholder="Search for buddies & boards" onkeyup="buddySearch(this.value)" id="buddySearchFiled">
    								...
    								for(var i in users){
    									...
    									if(users[i].lastName!=null){
    										...
    										if(buddyID!=users[i].userId){
    											...
    											htm +='<input type="hidden" value="'+ctx+'/buddy/'+users[i].firstName+'/'+users[i].userId+'/board/'+boardinfoId+'" name="url" id="url'+sequence+'">';
    											
    					                            htm+='<div class="media">'
    					                            +'<div class="media-left">'
    					                          +'<a href="'+ctx+'/buddy/'+users[i].firstName+'/'+users[i].userId+'/board/'+boardinfoId+'">';
    										...
    										for(var j in boards){
    												...
    												//if(boardId!=boards[j].boardId){
    													sequence=parseInt(sequence)+parseInt(1);
    													htm +='<li tabindex="'+sequence+'" class="selection-item">';
    													htm +='<input type="hidden" value="'+ctx+'/'+boards[j].boardName+'/board/'+boards[j].boardId+'/byBoard/'+boardinfoId+'" name="url" id="url'+sequence+'">';
    													
    							                           htm +='<div class="media">'
    							                            +'<div class="media-left">'
    							                            +'<a href="'+ctx+'/'+boards[j].boardName+'/board/'+boards[j].boardId+'/byBoard/'+boardinfoId+'">';
