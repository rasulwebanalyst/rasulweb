                       ...
                       <thead> 
                        ...
                        <c:forEach items="${team.tournamentList}" var ="teamlist" varStatus="index">
                        	 ...
                        	 <td style="text-align: center;">${index.count}</td>
		                          <td class="alignCenter" style="text-align: left;"><img src="${teamlist.boardUrl}" style="width: 25px;" onerror="imgError(this)"  ><a href="${pageContext.request.contextPath}/${teamlist.teamBoardName}/board/${teamlist.teamBoardId}"> <a href="javascript:void(0);" onclick="PleaseLogin()">${teamlist.teamBoardName}</a></a></td>
...
<script>
						...
						if(res.length > 0)
							...
							for(var i in res)
	                        	...
	                        	for(var j in tlist)
	                        		...
	                        		htm+="<td style='text-align: left;'><img src="+tlist[j].boardUrl+" style='width: 25px;' onerror='imgError(this)''  ><a href='${pageContext.request.contextPath}/"+tlist[j].teamBoardName+"/board/"+tlist[j].teamBoardId+"'> <a href='javascript:void(0);' onclick='PleaseLogin()'>"+tlist[j].teamBoardName+"</a></a></td>";
   ...
   function searchValiation()
   {
  	 ...
  	 if(tournment!='')
  		 {
  		 		/* return true; */
  		 		window.location.href="${pageContext.request.contextPath}/teamslistSite/"+tournment+"/${boardId}";
  		 }else{
