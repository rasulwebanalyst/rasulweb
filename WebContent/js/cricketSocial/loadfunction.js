		 		        	  	 ...
		 		        	  	 for(var j in res[i].tournamentScheduler){
			 		        	  		...
			 		        	  		if(res[i].tournamentScheduler[j]!=null)
			 		        	  			...
			 		        	  			if(res[i].tournamentScheduler[j].leagueInfo!=null){
						 		 				...
						 		 				htm +='<a href="'+ctx+'/'+res[i].tournamentScheduler[j].leagueInfo.boardName+'/board/'+res[i].tournamentScheduler[j].leagueInfo.boardId+'"><img src="'+res[i].tournamentScheduler[j].leagueInfo.boardImageURL+'" class="nav-avatar" onError="imgError(this)"> '+res[i].tournamentScheduler[j].leagueInfo.boardName+'</a>';
