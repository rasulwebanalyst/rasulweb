...
<body class="loginBody">
    ...
    <div class="container loginMiddleBlock">
        ...
        <div class="row">
            ...
            <div class="loginCenterBlock" style="background:rgba(255,255,255,0.8); border-top: #224e6b solid 3px; border-bottom: none;">
             ...
             <%--    <c:choose>
	                ...
	                <div class="media userDetailBlock">
	                  ...
	                  <div class="media-body userDet">
	                      ...
	                      <div class="form-group">
	                      	<form action="ManualLoginmail" name="resetPasswordWithAccount" method="post">
                ...
                <a href="${pageContext.request.contextPath}/ManualLoginYes"  class="btn btn-default blockBtn" >Close</a>
                </div>
                </c:when>
                <c:otherwise>
...
function closeFunction(){
	window.location.href = "${pageContext.request.contextPath}/ManualLoginYes";
}
