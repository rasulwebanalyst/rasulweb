    		...
    		<div class="col-md-10">
                       ...
                       <table>
                            	<thead>
                                	...
                                	<div id="battingNoData" style="color:red">No Details Available</div>
                    		  ...
                    		  var followofWicketsArr2=[];
                     		  ...
                     		  <c:forEach items="${score.firstInnings.battingPlayer}" var="player">
                     		  	...
                     		  	batsmanlist.push({                     		  		
                     		  			...
                     		  			strikeRate : "<fmt:formatNumber type='number' pattern='##########.##' value='${player.strikeRate}' />",
                     		  			runs : "${player.runs}",
                     		  		 });
                     		  </script>
                     		  </c:forEach>
                     		  <c:forEach items="${score.firstInnings.bowlingPlayer}" var="player">
                     		  	...
                     		  	bowlwerlist.push({                     		  		
                 		  			...
                 		  			six : "${player.six}",
                 		  			average : "<fmt:formatNumber type='number' pattern='##########.##' value='${player.average}' />",
                 		  			meidan : "${player.meidan}",
                 		  			econamyRate : "<fmt:formatNumber type='number' pattern='##########.##' value='${player.econamyRate}' />",
                                     ...
                                     bowingrowObj.push(
                                    		{
                                    			...
                                    			strikeRate : "<fmt:formatNumber type='number' pattern='##########.##' value='${bowling.strikeRate}' />"
