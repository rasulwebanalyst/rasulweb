                     	...
                     	<div class="col-md-12 statusUpdateBox whiteBox ">
                             ...
                             <div class="col-md-12 noPadding myscor">
                         	 ...
                         	 <table>
                                ...
                                <tbody>
                                	<tr><td><a href="${pageContext.request.contextPath}/scorecard/buddy/${battingInfo.battingName}/${battingInfo.battingId}">${battingInfo.battingName}</a></td>
                                    ...
                                    <tr><td><a href="${pageContext.request.contextPath}/scorecard/buddy/${runnerInfo.runnerName}/${runnerInfo.runnerId}">${runnerInfo.runnerName}</a></td>
                          ...
                          <table>
                                ...
                                <tbody>
                                	<tr>
                                        <td><a href="${pageContext.request.contextPath}/scorecard/buddy/${bowlingInfo.bowlerName}/${bowlingInfo.bowlerId}">${bowlingInfo.bowlerName}</a></td>
                         ...
                         <div class="col-md-12 statusUpdateBox whiteBox ">
                            ...
                            <div>
                            	...
                            	<c:otherwise>
                                	...
                                	<%-- <b style="font-size: 12px">${scoreCardList.gameDate}</b> --%>
...
<<<<<<< HEAD
                                	<tr><td style="width: 150px;"><a style="color: #227fbc;" href="${pageContext.request.contextPath}/scorecard/buddy/${list1.playerFullName}/${list1.playerId}">${list1.playerFullName}</a></td>
                                    	<c:choose>
                                    	<c:when test="${list1.wicketBy == 'NotOut' || list1.wicketBy == 'Not Out'}">
                                    	<td style="width: 150px; text-align: left;">not out</td>
                                    	</c:when>
                                    	...
                                    	<td style="width: 150px; text-align: left;">${list1.wicketBy }</td>
=======
                                	<tr><td style="width: 150px;"><a href="${pageContext.request.contextPath}/scorecard/buddy/${list1.playerFullName}/${list1.playerId}">${list1.playerFullName}</a></td>
                                    	<c:choose>
                                    	<c:when test="${list1.wicketBy == 'NotOut'}">
                                    	<td style="width: 150px;">Not Out</td>
                                    	</c:when>
