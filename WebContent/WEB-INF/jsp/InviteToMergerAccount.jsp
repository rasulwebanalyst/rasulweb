    ...
    <div class="col-md-12 middleContBlock noPadding">
      ...
      <div class="col-md-7 pageMiddleBlock">
      		<div class="col-md-12 whiteBox mybuddyBlock">
		          ...
		          <h1 class="">Invite to Merge Account</h1>
                    ...
                    <div role="tabpanel" class="tab-pane" id="InvitetoCricketSocial">
                            <div class="col-md-12 noPadding">
                              ...
                              <h2 style="padding-left:0px; " class="noBorder">Invite Buddy's by Email</h2>
                            ...
                            <div class="form-group col-md-12 noPadding">
                                         ...
                                         <button type="submit" class="btn  btn-default btn-sm  blockBtn " onclick="cancelFunction()">Skip</button>
                             </div>
                            </div>  
...
function inviteYourBuddieByMail(mailArrayParam){
	...
	if((mail != null && mail.trim() !="") || mailArrayParam !=null){
		...
		$.ajax({
			type : "POST",
			url :"${pageContext.request.contextPath}/inviteBuddyToMergeAccountByMail",
			dataType: "json",
			...
			success : function(res) {
				...
				window.location.href = "${pageContext.request.contextPath}/inviteToMergeAccount/boardId/"+bid;
