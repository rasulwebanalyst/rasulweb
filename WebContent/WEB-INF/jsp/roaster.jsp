                               ...
                               <c:choose>
                    				  ...
                    				  <div class="media-body">
                                       ...
                                       <%--   <a href="deleteRoster?rosterId=${RoasterResponseById.rosterDetails.rosterId}&bid=${BoradInfo.boardId}" class="btn btn-default btn-sm  dBtn pull-right ">Delete Roster</a> --%>
                                         <a href="javascript:" onclick="deleteRosterPoupShow('${RoasterResponseById.rosterDetails.rosterId}')" class="btn btn-default btn-sm  dBtn pull-right ">Delete Roster</a>                                
