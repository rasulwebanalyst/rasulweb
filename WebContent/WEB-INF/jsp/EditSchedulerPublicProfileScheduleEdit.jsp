                 ...
                 <%--  <table>
						...
						<div class="tBox"> 
                               <label for="email">Tournament Name</label>
                                ...
                                <div class="selectdiv">
                                    <select class="selectboxdiv" id="teamSelectBoxDIv" name="homeTeamId" onchange="teamValidation()">
                                ...
                                <div class="amdSbox"> 
                                 <label for="email">Select Away Team</label> 
                                    <div class="selectdiv">
                                       <select class="selectboxdiv" id="teamSelectBoxDIv1" name="awayTeamId" onchange="awayteamValidation()">
                                    <option value="0">Select Team Board</option>	
...
function afterValidation(){
	...
	success: function(res){
		if(res == 'success'){
			window.location.href = "${pageContext.request.contextPath}/ScheduleListPubProfWithEdit/boardId/"+boardId;
		}
	}, 
	error:function(err){
		alert(err);
