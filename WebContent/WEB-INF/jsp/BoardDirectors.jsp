    ...
    <div class="modal-content">
     <!--  <div class="modal-header">
      ...
      <!-- <div class="modal-body">
       ...
       <table class='bd-table' id='memberListDIV${loop.count}' style="box-shadow: none;">
			                    ...
			                    <!--  <td><label>Name<span class="req-star">*</span></label><input type='text' class='form-control' placeholder="Search" id="addMemberName" onkeyup="getBuddiesAutoComplete(this,'addMemberautoCompleteDIV','addMemberIDDIV')"></td> -->
			                     ...
			                     <tr><td><label>Position<span class="req-star">*</span></label><input type='text' class='form-control' id="addMemberPosition1" ></td></tr>
			                     <tr><td><label>Year<span class="req-star">*</span></label><input type='text' class='form-control' style="width: 60px; display: inline-block;" id="addMemberFromyear1" onkeypress="return isNumber(event)"><span style="float: none; display: inline-block; padding: 0 5px;">-</span><input type='text' class='form-control' style="width: 60px; display: inline-block;" id="addMemberToyear1" onkeypress="return isNumber(event)"></td></tr>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-12 noPadding profileForm">
                     ...
                     <tr><td><label>Name</label><input type='text'  id='DirectorName${loop.count}' class='form-control' readonly value='${sponserlist.directorName}'></td>
                     <td class="bd-txt-holder" rowspan="3"><label>Summary</label><textarea type='text' class='form-control' id='DirectorComments${loop.count}' readonly>${sponserlist.comments}</textarea></td></tr>
                     <tr><td><label>Position</label><input type='text' class='form-control' readonly value='${sponserlist.position}' id='DirectorPostion${loop.count}'></td></tr>
                     <tr><td><label>Year</label><input type='text' class='form-control' style="width: 60px; display: inline-block;" readonly value='${sponserlist.fromDate}' id='DirectorFromYear${loop.count}'><span style="float: none; display: inline-block; padding: 0 5px;">-</span><input type='text' class='form-control' style="width: 60px; display: inline-block;" readonly value='${sponserlist.toDate}' id='DirectorToYear${loop.count}'></td></tr>
                     <tr><td colspan="2"><label style="width: 100%;">Other Contacts</label>
                  ...
                  <%--    
	    	        ...
	    	        <td style='width: 100px'><button type='button' onclick="removeFromList(${loop.count})" class='btn' ><i class='fa fa-trash' aria-hidden='true'></i></button><button type='button' onclick="editFromList(${loop.count})" class='btn'><i class='fa fa-pencil' aria-hidden='true'></i></button></td>
            					...
            					<div class="form-group col-md-12 noPadding profileForm cs-bd-holder">	
			                     ...
			                     <td class="bd-txt-holder" rowspan="3"><label>Summary</label><textarea type='text' class='form-control' id='addMembercomment'></textarea></td></tr>
        ...
        function addmemberToRoster()
    {
        ...
        if(name.length ==0 || position.length == 0 || Fromyear.length ==0 )
        	...
        	return false;
	    	        ...
	    	        htm +="<tr><td><label>Name</label><input type='text'  id='DirectorName"+sequencNumber+"' class='form-control' value='"+name+"'></td>";
	    	        htm +="<td class='bd-txt-holder' rowspan='3'><label>Summary</label><textarea type='text' class='form-control' id='DirectorComments"+sequencNumber+"'>"+comment+"</textarea></td></tr>";
	    	        htm +="<tr><td><label>Position</label><input type='text' class='form-control' value='"+position+"' id='DirectorPostion"+sequencNumber+"'></td></tr>";
	    	        htm +="<tr><td><label>Year</label><input type='text' class='form-control' style='width: 60px; display: inline-block;' value='"+Fromyear+"' id='DirectorFromYear"+sequencNumber+"'><span style='float: none; display: inline-block; padding: 0 5px;'>-</span><input type='text' class='form-control' style='width: 60px; display: inline-block;' value='"+Toyear+"' id='DirectorToYear"+sequencNumber+"'></td></tr>";
