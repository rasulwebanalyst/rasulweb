    ...
    <div class="col-md-12 middleContBlock noPadding">
      ...
      <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
                  ...
                  <form id="tournamentForm"  action="${pageContext.request.contextPath}/insertTournamentDetails.htm" method="POST">
                                  <div class="col-md-6">
                                  	<label for="email"><span>*</span> Create Tournament / Trophy</label> <input type="text" class="form-control" placeholder="" id="tournamentName" name="tournamentName" onblur="tournamentNameValidation()">
                                  </div>
                                  ...
                                  <div class="col-md-6">
                                  	<label for="email"><span>*</span> Win Points for the Match</label> <input type="text" class="form-control number" placeholder="" id="winpoints" name="winpoints">
                                  </div>
...
>>>>>>> 9c4a9b6dae78b87b70036fc211fbe261dc7e18f2
                                 ...
                                 <div class="col-md-12 Create">
                                    <input type="button" class="btn btn-default dBtn" onclick="submitFunction()" value="Create Schedule">
