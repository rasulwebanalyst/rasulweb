      ...
      <div class="col-md-12 noPadding">
            ...
            <div class="col-md-10 pull-right">
      			<div class="col-md-12 whiteBox">
                	<h1 class="">EVENT LISTING <a href="${pageContext.request.contextPath}/create-buddyevent"></a></h1>
                      <c:choose>
...
<span><fmt:formatDate pattern="d" value="${event.eventDate}" /><br><fmt:formatDate pattern="E" value="${event.eventDate}" /></span>                                                     
		                         ...
		                         <c:choose>
		                         		<c:when test="${!empty event.usersInfo}">
		                         					<a href="${pageContext.request.contextPath}/buddy/${event.usersInfo.firstName}/${event.usersInfo.userId}"><img src="${event.usersInfo.userImageUrl}" class="nav-avatar" onerror="userErrorDefaultImg(this)"> ${event.usersInfo.firstName}</a>		
		                         		</c:when>
                     	...
                     	<c:forEach items="${schedual.tournamentSchedulerList}" var="event" varStatus="index">
                     			...
                     			<div class="col-md-12 noPadding leag-Acc">
			                        ...
			                        <div class="col-md-6 Leag-Img">
			                          <h4>${event.tournamentInfo.tournamentName}</h4>
			                          <p><fmt:formatDate pattern="d/M/YYYY hh:mm a" value="${event.gameDate}" /> </p>
			                           <p><a href="${pageContext.request.contextPath}/ ${event.homeTeamInfo.boardName}/board/ ${event.homeTeamInfo.boardId}">${event.homeTeamInfo.boardName}</a> Vs <a href="${pageContext.request.contextPath}/ ${event.awayTeamInfo.boardName}/board/ ${event.awayTeamInfo.boardId}">${event.awayTeamInfo.boardName}</a></p><br>
			                          <p>${event.groundDetails.groundName}<br>
			                          	${event.groundDetails.address1},${event.groundDetails.city}
			                          </p>
			                        </div>
