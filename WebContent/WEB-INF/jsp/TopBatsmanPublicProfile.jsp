      ...
      <div class="col-md-10">
      		...
      		<div class="col-md-12 whiteBox">
                  ...
                  <div class="col-md-12 noPadding">
                        ...
                        <label for="">Tournament</label> <input type="text" class="form-control" placeholder="" name="tournmentName" id="tournmentInField" onkeyup="tournmentSearch(this)"> 
                        ...
                        <div class="col-md-3">
                          <label for="">Team Name</label> <input type="text" name="homeTeamName" class="form-control" placeholder="" id="teamBoardInField" onkeyup="teamSearch(this)" > 
