      ...
      <div class="col-md-10">
      		...
      		<div class="col-md-12 whiteBox">
                  ...
                  <div class="col-md-12 noPadding">
                        ...
                        <div class="col-md-3">
                          <label for="">Team Name</label> <input type="text" class="form-control" placeholder="" id="teamBoardInField" name="homeTeamName" onkeyup="teamSearch(this)" value="${HalfCentrrySearch.homeTeamName}"> 
