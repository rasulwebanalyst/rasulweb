...
<%@ include file="BuddyPublicHeader.jsp" %>
		          ...
		          <h1 class="">Fan Of</h1>
                    ...
                    <div role="tabpanel" class="tabpanel">
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class=""><a href="#BoardFansListDIV" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false" onclick="buddyPublicProfileboardFansList()">Boards</a></li>
 ...
 <!-- jQuery -->
	...
	<script>
     ...
     <script type="text/javascript" src="${pageContext.request.contextPath}/js/cricketSocial/buddyFanOf.js"></script>
     
     
         <!--  <script type="text/javascript" src="js/cricketSocial/boardfunction.js"></script> -->
