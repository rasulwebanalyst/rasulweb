      ...
      <div class="col-md-12 noPadding">
           ...
           <div class="col-md-7">
      			<div class="col-md-12 whiteBox leag-Acc ">
                    ...
                    <input type="hidden" id="eventLogUserId" name="eventLogUserId" value="${BuddyPublicUserId}">
                    <input type="hidden" id="eventLogUserImg" name="eventLogUserImg" value="${BuddyPublicIMG}">
                    <input type="hidden" id="eventLogUserName" name="eventLogUserName" value="${BuddyPublicFirstName}">
                      <!-- Tab panes -->
																						                           		...
																						                           		<!-- <div class="col-md-1 eveDate"> -->
																									                    	 	...
																									                    	 	<div class="col-md-11 borderleft">
																											                         ...
																											                         <div class="col-md-12 noPadding eventUserDetails">
																											                         			...
																											                         			<img src="${BuddyPublicIMG}" class="nav-avatar" onerror="userErrorDefaultImg(this)">  ${BuddyPublicFirstName}
																											                      ...
																											                      <%--   <div class="col-md-6 threebtn">
																											                                ...
																											                                <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Rejected" disabled="disabled"><br><a href="javascript:gettingEventAcceptedPeopleList('${event.eventId}','reject${event.eventId}',143)">Rejected : ${event.rejectedCount}</a></p>
																											                                <p><input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="May Be" disabled="disabled"><br><a href="javascript:gettingEventAcceptedPeopleList('${event.eventId}','reject${event.eventId}',152)">May Be : ${event.maybeCount}</a></p>
																											                             	<p> <input src="" type="button" class="btn dBtn btn-sm pull-right btnalian1" value="Accepted" disabled="disabled"><br><a href="javascript:gettingEventAcceptedPeopleList('${event.eventId}','reject${event.eventId}',151)">Accepted : ${event.acceptedCount}  </a></p>
          ...
          <!--   <div class="col-md-3 pull-right">      			<div class="col-md-12 whiteBox noPadding">
