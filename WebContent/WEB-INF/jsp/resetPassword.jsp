    ...
    <div class="container loginMiddleBlock">
        ...
        <div class="row">
            ...
            <div class="loginCenterBlock">
                ...
                <h2 class="text-left">Reset your password</h2>
                ...
                <div class="rypDiv">
                        ...
                        <form role="form" method="POST" id="resetForm" name="resetForm" action="resetPassWord">
                        
                          <div class="form-group">
                          	<input type="radio" checked id="r1" name="rr" value="email" class="devClass">
				            <label for="r1"><span></span>By E-mail ID</label>
				            <div id="showHideEmail" style="display:none">
                            <input type="text" placeholder="Please enter Email" value="${email}" name="email" class="form-control tbox" id="emailId" >
                          	<div id="dis" style="color: red; text-align: left;"></div>
                          </div>
                          
                          </div>
                          <div class="form-group" style="display: none;">
                          	<input type="radio" id="r2" name="rr"  value="mobile" class ="devClass"> 
				            <label for="r2"><span></span>By Mobile Number</label>
				            <div id="showHideMob" style="display:none; margin-top: -8px;">
                            <input type="text" placeholder="Please enter mobile number" name="mobile" class="form-control tbox" id="mobileNumberId">
                         </div>
                         
                          </div>
                          
                          <div class="form-group">
                            <label style="margin-right:16px; height: 25px; float: left;"></label>
                            <button type="submit" class="btn btn-default dBtn" onclick="return validateResetForm()">Send</button>
