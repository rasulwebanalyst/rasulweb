...
<%@ include file="BoardFanMenu.jsp" %>  
      <form action="${pageContext.request.contextPath}/leagueTopFiveWicketsListPublicProfile" id="centuriesSearchForm" name="centuriesSearchForm" method="post" onsubmit="return searchValiation()">
      <div class="col-md-10">
      		...
      		<div class="col-md-12 whiteBox">
                  ...
                  <div class="col-md-12 noPadding">
                        ...
                        <label for="">Tournament</label> <input type="text" class="form-control" placeholder="" id="tournmentInField" onkeyup="tournmentSearch(this)" value="${FiveWicketSearch.tournmentName}" name="tournmentName"> 
                        ...
                        <div class="col-md-3">
                          <label for="">Team Name</label> <input type="text" class="form-control" placeholder="" id="teamBoardInField" onkeyup="teamSearch(this)" value="${FiveWicketSearch.homeTeamName}" name="homeTeamName"> 
                        ...
                        <div class="col-md-4">
                       <label for="">Team Against</label> <input type="text" placeholder="" class="form-control tbox" id="againestteamBoardInField" onkeyup="againestTeamSearch(this)" value="${FiveWicketSearch.againTeamName}" name="againTeamName">
            ...
            <div class="col-md-10 pull-right">
      		<div class="col-md-12 whiteBox">
                  ...
                  <%-- <c:choose>
                  <c:when test="${empty fiveWicket.matchsheduledtolist}"> 
...
<%@ include file="Footer.jsp" %>
   ...
   /*  var url = window.location.href;
    ...
    if(url.indexOf('leagueTopFiveWicketsListPublicProfile') != -1){
