                        ...
                        <div role="tabpanel" class="tab-pane active" id="BoardAllFansList">
                            <div class="col-md-12 noPadding" id="AllBoardAllFansList2">
								<c:choose>
										...
										<c:otherwise>
											...
											<div class="media  col-md-6" id="boardfanuser${user.userId}">
				                                ...
				                                <a href="${pageContext.request.contextPath}/buddy/${user.firstName}/${user.userId}">
				                                    <img src="${user.userImageUrl}" onError="this.onerror=null;this.src='${pageContext.request.contextPath}/images/profileIcon.png';"  >
				                                       ...
				                                       <a href="${pageContext.request.contextPath}/buddy/${user.firstName}/${user.userId}"> <h4 class="media-heading">${user.firstName}</h4></a>
				                                        <span class="date">${user.city}</span>
				                                         <a class="btn   btn-default btn-sm  btn-sm  blockBtn "  id="becomeFan${user.userId}" onclick="FanAction('${USRID}','${user.userId}','buddyUnFanOfToBuddy','buddyUnFanOfToBuddy')">Un Fan</a>
											...
											<div class="media  col-md-6 buddyBoardFan${user.boardId}" id="boardfanboard${user.boardId}">
				                                
				                                <div class="media-left buddyImg">
				                                <a href="${pageContext.request.contextPath}/${user.boardName}/board/${user.boardId}">
				                                    <img src="${user.boardImageURL}" onError="this.onerror=null;this.src='${pageContext.request.contextPath}/images/boardIcon.png';" >
				                                    </a>
				                                </div>
				                                
				                    				  <div class="media-body">
				                                        <h4 class="media-heading">${user.boardName}</h4>
				                                        <span class="date">${user.city}</span>
				                                         <a class="btn   btn-default btn-sm  btn-sm  blockBtn" id="boardfanuser${user.boardId}" onclick="FanAction('${user.boardId}','${USRID}','boardUnFanToBuddy','boardUnFanToBuddy')">Un Fan</a>
				                                         <a class="btn   btn-default btn-sm  btn-sm  blockBtn"  style="display: none;"  id="boardFan${user.boardId}" >Un Fan success</a>         
                           ...
                           <c:choose>
                           	<c:when test="${BoardFanCount > 10 || UserFanCount > 10}">
                          			 <a class="btn btn-default dBtn pull-right lodbtn" href="javascript:getallFanlistbypage('All',10,'AllBoardAllFansList2','AllFanOfListDivPagination')">Load more</a> 	
                           	</c:when>
