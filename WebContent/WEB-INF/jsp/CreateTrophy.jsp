    ...
    <div class="col-md-12 middleContBlock noPadding">
      ...
      <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
            	<h1 class="">Create Trophy</h1>
                
		          <div class="tourntBtns">
                    <a href="${pageContext.request.contextPath}/CreateTournament/boardId/${boardId}">Create Manual Tournament</a>
                    <%-- <a href="${pageContext.request.contextPath}/RollOverTournament/boardId/${boardId}">Roll over from Previous Tournament</a> --%>
                </div>
