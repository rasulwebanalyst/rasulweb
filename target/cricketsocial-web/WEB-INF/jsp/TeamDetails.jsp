                       ...
                       <thead> 
                        ...
                        <c:forEach items="${team.tournamentList}" var ="teamlist" varStatus="index">
                        	 ...
                        	 <td style="text-align: center;">${index.count}</td>
		                          <td style="text-align: left;"><img src="${teamlist.boardUrl}" style="width: 25px;" onerror="imgError(this)"  ><a href="${pageContext.request.contextPath}/${teamlist.teamBoardName}/board/${teamlist.teamBoardId}"> ${teamlist.teamBoardName}</a></td>
