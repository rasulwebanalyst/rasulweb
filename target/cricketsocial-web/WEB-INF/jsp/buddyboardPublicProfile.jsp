...
<div class="userName col-md-10" id="likesDiv">
							...
							<div class="hitBoard">
							           ...
							           <%--  <c:choose>
							                   		<c:when test="${BoardFanToBuddy}">
							                   			<a href="javascript:" class=""> <span>Fan</span> <span>(${BuddyPublicFanCount})</span></a>
							                   		</c:when>
							                   		<c:otherwise>
							                   			<a href="javascript:FanAction('${ViewBoradInfo.boardId}','${BuddyPublicUserId}','boardFanToBuddy','boardfanuser')" class="" id="becomeFan${BuddyPublicUserId}"> <span>Become a Fan</span><span>(${BuddyPublicFanCount})</span> </a>
							            ...
							            <c:choose>
							                   		...
							                   		<c:otherwise>
							                   			<a href="javascript:FanAction('${BoardFanId}','${BuddyPublicUserId}','boardFanToBuddy','boardFanToBuddy')" class="" id="becomeFan${BuddyPublicUserId}"> <span>Become a Fan</span><span>(${fancount})</span> </a>
