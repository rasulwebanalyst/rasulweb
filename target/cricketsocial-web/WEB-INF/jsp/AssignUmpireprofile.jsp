...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
     ...
     <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
                  ...
                  <form id="filterForm" method="POST" action="${pageContext.request.contextPath}/filterForScheduleListAssignUmpirePubProf.htm">
                  <div class="col-md-12 noPadding">
      ...
      <div class="col-md-10">
      		<div class="col-md-12 whiteBox">
		          <%-- <h1 class="">Assign a umpire to a schedule
